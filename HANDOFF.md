...
| `test_scanner.py` | 64 akseptansetester. Kjøres uten nett, med syntetiske kursserier |
...
2. **`python test_scanner.py` skal være 64/64 før hver push.** Feiler noe,
...
python test_scanner.py          # skal være 64/64
